...
(define user2 '("Inicio" "Mi nombre es Nadia" "Quiero comprar un Auto" "Deseo adquirir comprar un Peugeot" "Quiero adquirir un FordRaptor" "Quiero adquirir un 206" "Realizar Compra" "Forzar Compra" "Fin"))
...
(define (cmpFord phrase)
  (if (list? phrase)
      (if (or (and (inList phrase '("quiero" "deseo")) (inList phrase '("comprar" "adquirir")) (inList phrase '("auto")) (inList phrase '("ford")))
              (and (inList phrase '("quiero" "deseo")) (inList phrase '("auto")) (inList phrase '("ford")))
...
(define (cmpToyota phrase)
  (if (list? phrase)
      (if (or (and (inList phrase '("quiero" "deseo")) (inList phrase '("comprar" "adquirir")) (inList phrase '("auto")) (inList phrase '("toyota")))
              (and (inList phrase '("quiero" "deseo")) (inList phrase '("auto")) (inList phrase '("toyota")))
...
(define (cmpPeugeot phrase)
  (if (list? phrase)
      (if (or (and (inList phrase '("quiero" "deseo")) (inList phrase '("comprar" "adquirir")) (inList phrase '("auto")) (inList phrase '("peugeot")))
              (and (inList phrase '("quiero" "deseo")) (inList phrase '("auto")) (inList phrase '("peugeot")))
